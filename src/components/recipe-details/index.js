    ...
    <div>
      ...
      <div className="p-6 lg:max-w-6xl max-w-2xl mx-auto">
        <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="mt-5">
            <h2 className="text-3xl font-extrabold text-grey-950">
              {getRecipeDetails?.name}
            </h2>
            <div className="gap-4 mt-5">
              <p className="text-2xl text-grey-700">
            ...
            <div className="mt-5">
              <h3 className="text-lg font-bold text-grey-700">Ingredients</h3>
              <ul className="space-y-3 list-disc mt-4 pl-4 text-sm text-grey-700">
